...
map:
    # Arguments: a1: pointer to square function
    # a0: address of the first node
    ...
    add s0, a0, x0 # s0: address of this node
    add s1, a1, x0 # s1: pointer to the square
    ...
    # THINK: Why a0? I will pass the argument to square
    ### YOUR CODE HERE ###
    lw a0, 0(s0)
